...
public class PanelBusqueda extends JPanel {
    ...
    private void cargarDatosPrecargados() {
        arbol.insertaNodo(new Producto("P001", "Arroz ", 3.50, 100));
        arbol.insertaNodo(new Producto("P002", "Leche Gloria ", 4.20, 80));
        arbol.insertaNodo(new Producto("P003", "Aceite Primor ", 8.90, 50));
        arbol.insertaNodo(new Producto("P004", "Fideos Don Vittorio", 2.80, 120));
        arbol.insertaNodo(new Producto("P005", "Jabón Bolívar", 2.10, 60));
        arbol.insertaNodo(new Producto("P006", "Yogurt Laive", 5.50, 40));
        arbol.insertaNodo(new Producto("P007", "Detergente Ariel", 12.90, 30));
        contadorCodigo = 8;
    }
}
